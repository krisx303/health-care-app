...
public class TemperatureModelArrayAdapter extends ArrayAdapter<TemperatureModel> {
    private final List<TemperatureModel> list;
    private final Activity context;

    public TemperatureModelArrayAdapter(Activity context, List<TemperatureModel> list){
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.textViewData.setText(list.get(position).getDate() + " - " + list.get(position).getTemperature() + "*C");
        return view;
    }
}
